    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active open">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item <?php if (url_is('admin/machines*')): ?>active<?php endif; ?>">
                    <a href="<?= route_to("machines") ?>" class="menu-link">Machines
                    </a>
                </li> 
                <li class="menu-item <?php if (url_is('admin/costcenters*')): ?>active<?php endif; ?>">
                    <a href="<?= route_to("costcenters") ?>" class="menu-link">Kostenplaats
                    </a>
                </li>             
                <li class="menu-item <?php if (url_is('admin/lubricants*')): ?>active<?php endif; ?>">
                    <a href="<?= route_to("lubricants") ?>" class="menu-link">Smeermiddelen
                    </a>
                </li>
                <li class="menu-item <?php if (url_is('admin/jobtypes*')): ?>active<?php endif; ?>">
                    <a href="<?= route_to("jobtypes") ?>" class="menu-link">Taak type
                    </a>
                </li>
